...
BEGIN
    ...
    IF email_count = 0 THEN
        INSERT INTO USER_LOGIN (EMAIL, PASSWD, POINTS, ISLOGGED)
        VALUES (EMAIL_ID, PASSWD, 0, FALSE);
...
BEGIN
    ...
    IF EXISTS (
        ...
        -- Toggle the IS_LOGGED state
        UPDATE USER_LOGIN
        SET IS_LOGGED = NOT IS_LOGGED
        WHERE EMAIL = EMAIL_ID;
